...
$("#add_family_form").validate({
  ...
  messages:{
    ...
    Recordnumber:{
      required: "الرجاء ادخال رقم ورقة ورقة العائلة!",
    },
    FamilyRecordDate:{
      required: "الرجاء ادخال التاريخ!",
    },
    Autogenerated_Id:{
      required: "الرجاء ادخال الرقم الالي!",
    },
    Is_Closed:{
      required: "الرجاء اختيار حالة الاسرة!",
    },
    OfficeId:{
      required: "الرجاء اختيار السجل المدني!",
    },
  },
